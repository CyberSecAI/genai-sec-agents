...
- ASVS markdown preservation system for semantic search integration
...
2. **ASVS Content Preserver**: Download and cache original ASVS markdown files
3. **Integration Analyzer**: LLM determines enhancement vs. new rule creation
4. **Rule Enhancer**: Merge ASVS guidance into existing rules
5. **Quality Validator**: Ensure integration maintains rule quality
...
## **Semantic Search Integration Requirements**

### **ASVS Content Preservation Strategy**
The domain integration must preserve original ASVS markdown files for semantic search corpus enhancement:

**Content Storage Structure:**
```
app/semantic/sources/asvs/
├── v5.0/
│   ├── 0x10-V1-Encoding-Sanitization.md
│   ├── 0x11-V2-Validation-Business-Logic.md
│   ├── 0x15-V6-Authentication.md
│   ├── 0x20-V11-Cryptography.md
│   └── ...
└── metadata.json  # Version tracking and source attribution
```

**Semantic Integration Process:**
1. **Download Preservation**: Fetch and cache original ASVS markdown during rule generation
2. **Version Tracking**: Track ASVS version (5.0) and GitHub commit hashes for change detection
3. **Provenance Metadata**: Maintain clear source attribution for semantic search results
4. **Corpus Enhancement**: Integrate ASVS content into existing semantic search corpus alongside Rule Cards
5. **Search Enhancement**: Enable developers to find both Rule Cards and original ASVS context

**Benefits for Developers:**
- **Comprehensive Context**: Access both processed Rule Cards and original ASVS documentation
- **Source Verification**: Validate Rule Card accuracy against original ASVS requirements
- **Additional Detail**: Access comprehensive explanations beyond distilled Rule Card format
- **Standards Compliance**: Reference original ASVS text for compliance and audit purposes
